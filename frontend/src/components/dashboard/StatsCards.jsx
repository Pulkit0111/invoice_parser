...
function StatsCards({ stats, loading }) {
  ...
  const statsConfig = [
    ...
    },
    {
      id: 'storage_used',
      title: 'Storage Used',
      value: formatStorageSize(stats?.storage_used || 0),
      icon: ChartBarIcon,
      iconBg: 'bg-orange-100',
      iconColor: 'text-orange-600',
      subtitle: `of ${formatStorageSize(stats?.storage_limit || 1000)} limit`,
      progress: stats?.storage_used && stats?.storage_limit ? 
        (stats.storage_used / stats.storage_limit) * 100 : 0
    }
  ];
