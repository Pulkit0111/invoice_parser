      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Welcome, <span className="font-semibold text-violet-600">{user?.name}</span>! 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="w-12 h-12 bg-violet-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <span className="text-lg font-semibold text-violet-600">1</span>
              </div>
              <h4 className="font-medium text-gray-900 mb-2">Upload</h4>
              <p className="text-sm text-gray-600">
                Drag and drop or browse to select your invoice file (JPG, PNG, or PDF)
              </p>
            </div>
            
            <div className="text-center">
              <div className="w-12 h-12 bg-violet-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <span className="text-lg font-semibold text-violet-600">2</span>
              </div>
            ...
            <div className="text-center">
              <div className="w-12 h-12 bg-violet-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <span className="text-lg font-semibold text-violet-600">3</span>
              </div>
              <h4 className="font-medium text-gray-900 mb-2">Save</h4>
              <p className="text-sm text-gray-600">
